...
\\
Torej, da najdemo graf na $n$ vozliščih z $min(wSz)$ bomo grafu na $(n-1)$ vozliščih z že minimiziranim $wSz$ dodali vozlišle in povezavo in ga spreminjali ter te spremembe obdržali, če je $wSz$ novega grafa manjši. Ko $wSz$ ne bomo mogli več zmanjšati, algoritem oz. ponovitve algoritma zaključimo. Algoritem deluje po sistemu simulated annealing, kjer z naključno izbiro skušamo najti ekstrem danega kriterija.
...
Da  zadnji graf res minimizira $wSz$ trdimo, ker se z algoritmom ne spremeni več.
...
Če si pogledamo še nekaj naslednjih grafov z minimalnim $wSz$, opazimo, kako z večanjem števila vozlišč nastane novo poddrevo, ki se bliža korenu drevesa.
